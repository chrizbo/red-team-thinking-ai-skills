Turns the same scrutiny used on human arguments back onto an AI's own output — checking a model's recommendation or analysis for hallucinated claims, unsupported leaps, missing counter-evidence, and framing bias. Use when a user wants to red-team an AI-generated answer or recommendation rather than accept it at face value, or explicitly asks to dissect an AI response.
